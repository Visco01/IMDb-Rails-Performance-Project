    ...
    TSV[file].each_slice(slice_length).with_index do |batch, batch_index|
      ActiveRecord::Base.transaction do
        batch.each_with_index do |row, i|
          ...
          puts "Title Principals: Processing record #{record_index} and time elapsed: #{Time.now - start_time}" if (record_index % slice_length).zero?
          ...
          begin
            ...
            TitlePrincipal.create(title_basic: title_basic,
                ordering: ordering,
